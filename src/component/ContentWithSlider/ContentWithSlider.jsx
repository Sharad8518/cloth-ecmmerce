...
<Col
  ...
  style={{
    height: "100vh",
    backgroundColor: "#dfe6e9", // dark background, can replace with an image or gradient
  }}
>
  ...
  <Button variant="light" size="lg" className="rounded-pill shadow" style={{fontSize:13}}>
    Shop the Collection
  </Button>
</Col>
