    ...
    <div style={{
        ...
        {!isOTPSent ? (
          <>
            ...
            <input
              ...
              style={{ width: "100%", padding: 12, margin: "20px 0", borderRadius: 6, border: "1px solid #ccc", fontSize: 16 }}
            />
            <button
              onClick={handleSendOTP}
              style={{ width: "100%", padding: 12, borderRadius: 6, backgroundColor: "#007bff", color: "#fff", border: "none", fontSize: 16, cursor: "pointer" }}
            >
              Send OTP
            </button>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", margin: "20px 0" }}>
              {otp.map((digit, idx) => (
                <input
                  ...
                  style={{ width: 40, height: 50, fontSize: 24, textAlign: "center", borderRadius: 6, border: "1px solid #ccc" }}
                />
              ))}
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ color: "#007bff", cursor: "pointer" }} onClick={handleResendOTP}>Resend OTP</span>
              <button
                onClick={handleVerifyOTP}
                style={{ padding: "10px 20px", backgroundColor: "green", color: "#fff", border: "none", borderRadius: 6, cursor: "pointer" }}
              >
                Verify
              </button>
            </div>
            {message && <p style={{ marginTop: 15, color: "#333" }}>{message}</p>}
          </>
        )}
      </div>
      ...
      <div className="right-image" style={{
        ...
        <img
          ...
          style={{ width: "80%", animation: "float 2s ease-in-out infinite" }}
        />
      </div>
